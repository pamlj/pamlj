...
pamlpropClass <- if (requireNamespace('jmvcore', quietly=TRUE)) R6::R6Class(
    "pamlpropClass",
    inherit = pamlpropBase,
    private = list(
        .time = NULL,
        .ready= FALSE,
        .smartObjs=list(),
        ...
        .init = function() {
                ...
                jinfo(paste("MODULE:  PAMLprop #### phase init  ####"))
     ...
     ### set up the R6 workhorse class
                private$.runner          <-  Runner$new(self)
                 ...
                 aSmartObj$hideOn<-list("n1"=NA, "n2"=NA)
        ...
        .run = function() {
                ...
                jinfo(paste("MODULE:  PAMLprop #### phase run  ####"))
                 private$.runner$run()
