...
pamlgzlmClass <- if (requireNamespace('jmvcore', quietly=TRUE)) R6::R6Class(
    "pamlgzlmClass",
    inherit = pamlgzlmBase,
    private = list(
        .time = NULL,
        .ready= FALSE,
        .smartObjs=list(),
        ...
        .init = function() {
                ...
                jinfo(paste("MODULE:  PAML gzlm #### phase init  ####"))
     ...
     ### set up the R6 workhorse class
      ...
      ### info table ###
        ...
        .run = function() {
                ...
                jinfo(paste("MODULE:  PAML gzlm #### phase run  ####"))
                 private$.runner$run()
