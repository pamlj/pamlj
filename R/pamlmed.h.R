...
pamlmedOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlmedOptions",
...
pamlmedResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlmedResults",
...
pamlmedBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlmedBase",
