...
pamlttestOptions <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlttestOptions",
...
pamlttestResults <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlttestResults",
...
pamlttestBase <- if (requireNamespace("jmvcore", quietly = TRUE)) {
    R6::R6Class(
        "pamlttestBase",
